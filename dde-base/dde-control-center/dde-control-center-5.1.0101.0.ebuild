...
PATCHES=(
	"${FILESDIR}/5.1.0101.0-missing-include.patch"
)
...
src_prepare() {
	...
	sed -i 's/slider2->setEnabledAcrossStyle/\/\/slider2->setEnabledAcrossStyle/' \
		src/frame/window/modules/sound/speakerpage.cpp || die
